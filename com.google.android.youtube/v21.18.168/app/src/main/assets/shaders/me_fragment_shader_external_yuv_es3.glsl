...
// LINT.ThenChange(//depot/google3/third_party/java_src/android_libs/media/libraries/common/src/main/java/androidx/media3/common/C.java:color_transfer)
...
void main() {
  ...
  outColor = vec4(applyOetf(opticalColor.rgb), 1.0);
}
